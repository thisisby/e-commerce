...
func main() {
	...
	err = seeder.CategoriesSeeder(seeders.CategoriesData)
	if err != nil {
		slog.Error("[Seed]: failed to seed categories data", err)
	}

	err = seeder.SubCategoriesSeeder(seeders.SubCategoriesData)
	if err != nil {
